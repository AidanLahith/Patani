    ...
    @if(!Auth::user()->isPremium() && !$transaksiList->where('status', 'pending')->count())
        <div class="bg-white rounded-xl shadow border p-6">
            ...
            <form action="{{ route('dashboard.transaksi.store') }}" method="POST" x-data="{ paket: '' }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div :class="paket === '12_bulan' ? 'border-blue-400 bg-blue-50 shadow-md' : 'border-gray-200'"
                            ...
                            <div x-show="paket === '12_bulan'"
                                 class="absolute top-3 right-3 w-5 h-5 bg-blue-400 rounded-full flex items-center justify-center">
                                <i class="fas fa-check text-white text-xs"></i>
                            </div>
                        </div>
                    </label>
                ...
                {{-- Tombol Bayar — selalu tampil, Alpine hanya untuk styling aktif --}}
                <button type="submit"
                        class="w-full font-bold py-3 rounded-xl transition flex items-center justify-center gap-2"
                        :class="paket
    ...
    <div class="bg-white rounded-xl shadow border p-6">
        ...
        @else
            <div class="flex flex-col items-center justify-center py-10 text-gray-400">
                ...
                <p class="text-sm mt-1">Transaksi premium Anda akan muncul di sini</p>
            </div>
        @endif
    </div>
