...
<div class="space-y-6" x-data="{ activeTab: '<?php echo e(session('active_tab', 'profil')); ?>' }">
    ...
    <div x-show="activeTab === 'profil'" x-transition class="space-y-5">
        ...
        <div class="bg-white rounded-xl shadow p-5 flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            <div class="relative group shrink-0">
                <?php if($admin->foto_profil && Storage::exists('public/' . $admin->foto_profil)): ?>
                    <img src="<?php echo e(Storage::url($admin->foto_profil)); ?>"
                         alt="Foto Profil"
                ...
                <form id="form-quick-foto" method="POST"
                      action="<?php echo e(route('admin.pengaturan.foto')); ?>"
            ...
            <div class="text-center sm:text-left">
                <h2 class="text-xl font-bold text-gray-800"><?php echo e($admin->name); ?></h2>
                ...
                <p class="text-gray-500 text-sm mt-1"><?php echo e($admin->email); ?></p>
                <div class="flex flex-wrap gap-3 mt-3 text-xs text-gray-500">
                    ...
                    <span class="flex items-center gap-1">
                        ...
                        <?php echo e($admin->desa ? $admin->desa . ', ' . $admin->kecamatan : '-'); ?>

                    </span>
                    <span class="flex items-center gap-1">
                        <i class="fas fa-calendar text-green-500"></i>
                        Bergabung <?php echo e($admin->created_at->format('d M Y')); ?>
        ...
        <div class="bg-white rounded-xl shadow p-6" x-data="{ section: 'data' }">
            ...
            <div x-show="section === 'data'" x-transition>
                <form action="<?php echo e(route('admin.pengaturan.profil')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $admin->email)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                                required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" value="<?php echo e(old('nik', $admin->nik)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                        ...
                        <div>
                            ...
                            <input type="text" name="desa" value="<?php echo e(old('desa', $admin->desa)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                                placeholder="Nama desa">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Kecamatan</label>
                            <input type="text" name="kecamatan" value="<?php echo e(old('kecamatan', $admin->kecamatan)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="2"
                            ...
                            placeholder="Jl. Contoh No. 1 ..."><?php echo e(old('alamat', $admin->alamat)); ?></textarea>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm border border-gray-100">
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">
                                <i class="fas fa-circle text-xs"></i> <?php echo e(ucfirst($admin->status ?? 'aktif')); ?>

                            </span>
                        </div>
                        <div>
                            <span class="text-gray-400 text-xs block mb-0.5">Bergabung</span>
                            <span class="font-medium"><?php echo e($admin->created_at->format('d M Y')); ?></span>
                        </div>
                        <div>
                            <span class="text-gray-400 text-xs block mb-0.5">Diperbarui</span>
                            <span class="font-medium"><?php echo e($admin->updated_at->format('d M Y')); ?></span>
                        </div>
                    </div>
            ...
            <div x-show="section === 'foto'" x-transition>
                <form action="<?php echo e(route('admin.pengaturan.foto')); ?>" method="POST"
                      enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-8">
                        ...
                        <div class="relative shrink-0">
                            <img :src="preview || '<?php echo e($admin->foto_profil ? Storage::url($admin->foto_profil) : 'https://ui-avatars.com/api/?name=' . urlencode($admin->name) . '&background=16a34a&color=fff&size=128'); ?>'"
                                 alt="Foto Profil"
            ...
            <div x-show="section === 'password'" x-transition>
                <form action="<?php echo e(route('admin.pengaturan.password')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="app_name"
                        value="<?php echo e($pengaturan['app_name'] ?? 'PATANI'); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email Kontak</label>
                    <input type="email" name="contact_email"
                        value="<?php echo e($pengaturan['contact_email'] ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                ...
                <div>
                    ...
                    <input type="text" name="contact_phone"
                        value="<?php echo e($pengaturan['contact_phone'] ?? ''); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-300 focus:border-green-500"
                        placeholder="08xxxxxxxxxx">
                </div>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\patani\laravel-patani\resources\views/admin/pengaturan.blade.php ENDPATH**/ ?>